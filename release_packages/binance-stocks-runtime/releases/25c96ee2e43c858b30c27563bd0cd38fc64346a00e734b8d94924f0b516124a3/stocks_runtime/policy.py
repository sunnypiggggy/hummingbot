...
class StocksExecutorPolicy:
    ...
    async def _validate(
        ...
        *,
        ...
        exposure = (
            await self.ledger.managed_exposure(self.prices, exclude_executor_id=exclude_executor_id)
            if exclude_executor_id else await self.ledger.managed_exposure(self.prices)
        )
        ...
        symbol_exposure = (
            await self.ledger.managed_symbol_exposure(
                symbol, price, exclude_executor_id=exclude_executor_id
            ) if exclude_executor_id else
            await self.ledger.managed_symbol_exposure(symbol, price)
        )
